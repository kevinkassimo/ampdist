...
},{"./event-helper-listen":1,"./log":4}],3:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./mode":6,"./mode-object":5,"./types":7}],5:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./url-parse-query-string":8}],7:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./url-try-decode-uri-component":9}],9:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"../types":7}],12:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
exports.AmpVideoIntegration = undefined;
 ...
 * }}
 */
var JwplayerPartialInterfaceDef = void 0;
...
var AmpVideoIntegration = exports.AmpVideoIntegration = function () {

  /** @param {!Window} win */
  function AmpVideoIntegration(win) {
    var _this = this;

    _classCallCheck(this, AmpVideoIntegration);
  ...
  _createClass(AmpVideoIntegration, [{
    key: 'getMetadata',
    ...
    key: 'listenTo',
    value: function listenTo(type, obj) {
    ...
    value: function listenToJwPlayer_(player) {
      ...
      ['error', 'setupError'].forEach(function (e) {
        player.on(e, function () {
          ...
          _this2.postEvent('error');
        });
      });

      ['adSkipped', 'adComplete', 'adError'].forEach(function (e) {
        player.on(e, function () {
          return _this2.postEvent('ad_end');
        });
      });

      player.on('adStarted', function () {
        return _this2.postEvent('ad_start');
      });
      ...
      Object.keys(redispatchAs).forEach(function (e) {
        player.on(e, function () {
          return _this2.postEvent(redispatchAs[e]);
        });
      });

      player.on('volume', function (e) {
        return _this2.onVolumeChange_(e.volume);
      });
    ...
    value: function listenToVideoJs_(element) {
      var _this3 = this;

      userAssert(this.win_.videojs, 'Video.JS not imported.');

      // Retrieve lazily.
      var player = (0, _function.once)(function () {
        return _this3.win_.videojs.getPlayer(element);
      });

      ['canplay', 'playing', 'pause', 'ended'].forEach(function (e) {
        (0, _eventHelper.listen)(element, e, function () {
          return _this3.postEvent(e);
        });
      });

      (0, _eventHelper.listen)(element, 'volumechange', function () {
        return _this3.onVolumeChange_(player().volume());
      });
    ...
    value: function postEvent(event) {
      ...
      this.postToParent_((0, _object.dict)({ 'event': event }));
    }
    ...
    value: function postToParent_(data, opt_callback) {
      ...
      var completeData = Object.assign({ id: id }, data);
    ...
    key: 'getIntersectionForTesting_',
    value: function getIntersectionForTesting_(callback) {
      return this.postToParent_((0, _object.dict)({ 'method': 'getIntersection' }), callback);
    }
  }]);
...
function listenTo(win, onMessage) {
  (0, _eventHelper.listen)(win, 'message', function (e) {
    return onMessage((0, _json.tryParseJson)((0, _eventHelper.getData)(e)));
  });
}
...
},{"../src/event-helper":2,"../src/json":3,"../src/mode":6,"../src/types":7,"../src/utils/function":10,"../src/utils/object":11,"../src/utils/promise":12}]},{},[13])
