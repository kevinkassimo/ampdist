...
exports.collapseFrame = exports.expandFrame = undefined;
...
var expandFrameImpl = function expandFrameImpl(win, iframe, onFinish) {
  (0, _util.restrictedVsync)(win, {
    ...
    mutate: function mutate(state) {
      var collapsedRect = (0, _layoutRect.layoutRectFromDomRect)(state.rect);
      var expandedRect = (0, _layoutRect.layoutRectLtwh)(0, 0, state.viewportSize.width, state.viewportSize.height);

      (0, _fullOverlayFrameHelper.centerFrameUnderVsyncMutate)(iframe, state.rect, state.viewportSize, CENTER_TRANSITION_TIME_MS);
    ...
    mutate: function mutate() {
      ...
      (0, _util.restrictedVsync)(win, {
        measure: function measure() {
          onMeasure((0, _layoutRect.layoutRectFromDomRect)(iframe. /*OK*/getBoundingClientRect()));
        }
      });
    }
  });
 ...
 * @param {function(!LayoutRectDef, !LayoutRectDef)} onFinish
 */
var expandFrame = exports.expandFrame = expandFrameImpl;
 ...
 * @param {function(!LayoutRectDef)} onMeasure
 */
var collapseFrame = exports.collapseFrame = collapseFrameImpl;
...
},{"../../src/full-overlay-frame-helper":21,"../../src/layout-rect":23,"./util":6}],2:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.FrameOverlayManager = undefined;
 ...
 */
var FrameOverlayManager = exports.FrameOverlayManager = function () {

  /**
   * @param {!Window} win
   */
  function FrameOverlayManager(win) {
    _classCallCheck(this, FrameOverlayManager);
  ...
  _createClass(FrameOverlayManager, [{
    ...
    key: 'expandFrame',
    value: function expandFrame(iframe, callback) {
      var _this2 = this;
    ...
    key: 'collapseFrame',
    value: function collapseFrame(iframe, callback) {
      var _this3 = this;
 ...
 * @param {!Window} win
 */
exports.InaboxHost = function InaboxHost(win) {
  _classCallCheck(this, InaboxHost);
  ...
  if (win[INABOX_IFRAMES] && !Array.isArray(win[INABOX_IFRAMES])) {
    (0, _log.dev)().info(TAG, 'Invalid ' + INABOX_IFRAMES, win[INABOX_IFRAMES]);
    win[INABOX_IFRAMES] = [];
  }
    ...
    if (Array.isArray(queuedMsgs)) {
      queuedMsgs.forEach(function (message) {
        ...
        try {
          ...
          (0, _log.dev)().error(TAG, 'Error processing inabox message', message, err);
        }
      });
    } else {
      (0, _log.dev)().info(TAG, 'Invalid ' + PENDING_MESSAGES, queuedMsgs);
    }
  }
...
function validateMessage(message) {
  ...
  if (!valid) {
    (0, _log.user)().error(TAG, 'Missing message.source. message.data=' + JSON.stringify((0, _eventHelper.getData)(message)));
  }
  return valid;
}
...
},{"../../src/error":16,"../../src/event-helper":18,"../../src/log":24,"./inabox-messaging-host":4}],4:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.InaboxMessagingHost = undefined;
...
var AdFrameDef = void 0;

var InaboxMessagingHost = exports.InaboxMessagingHost = function () {
  ...
  function InaboxMessagingHost(win, iframes) {
    _classCallCheck(this, InaboxMessagingHost);
    ...
    this.frameOverlayManager_ = new _frameOverlayManager.FrameOverlayManager(win);
  ...
  _createClass(InaboxMessagingHost, [{
    key: 'processMessage',
    ...
    value: function handleSendPositions_(iframe, request, source, origin) {
      var _this = this;

      var viewportRect = this.positionObserver_.getViewportRect();
      var targetRect = (0, _layoutRect.layoutRectFromDomRect)(iframe. /*OK*/getBoundingClientRect());
      this.sendPosition_(request, source, origin, (0, _object.dict)({
        'viewportRect': viewportRect,
        'targetRect': targetRect
      }));

      (0, _log.dev)().assert(this.iframeMap_[request.sentinel]);
      this.iframeMap_[request.sentinel].observeUnregisterFn = this.iframeMap_[request.sentinel].observeUnregisterFn || this.positionObserver_.observe(iframe, function (data) {
        return _this.sendPosition_(request, source, origin, /** @type ?JsonObject */data);
      });
      return true;
    }
    ...
    key: 'sendPosition_',
    value: function sendPosition_(request, source, origin, data) {
      (0, _log.dev)().fine(TAG, 'Sent position data to [' + request.sentinel + ']', data);
      source. /*OK*/postMessage((0, _pFrameMessaging.serializeMessage)(_pFrameMessaging.MessageType.POSITION, request.sentinel, data), origin);
    }
    ...
    value: function handleEnterFullOverlay_(iframe, request, source, origin) {
      this.frameOverlayManager_.expandFrame(iframe, function (boxRect) {
        source. /*OK*/postMessage((0, _pFrameMessaging.serializeMessage)(_pFrameMessaging.MessageType.FULL_OVERLAY_FRAME_RESPONSE, request.sentinel, (0, _object.dict)({
          'success': true,
          'boxRect': boxRect
        })), origin);
      });
    ...
    value: function handleCancelFullOverlay_(iframe, request, source, origin) {
      this.frameOverlayManager_.collapseFrame(iframe, function (boxRect) {
        source. /*OK*/postMessage((0, _pFrameMessaging.serializeMessage)(_pFrameMessaging.MessageType.CANCEL_FULL_OVERLAY_FRAME_RESPONSE, request.sentinel, (0, _object.dict)({
          'success': true,
          'boxRect': boxRect
        })), origin);
      });
      ...
      for (var i = 0; i < this.iframes_.length; i++) {
        ...
        for (var j = 0, tempWin = measurableWin; j < 10; j++, tempWin = tempWin.parent) {
          if (iframe.contentWindow == tempWin) {
            this.iframeMap_[sentinel] = { iframe: iframe, measurableFrame: measurableFrame };
    ...
    value: function getMeasureableFrame(win) {
      ...
      var topXDomainWin = void 0;
      for (var j = 0, tempWin = win; j < 10 && tempWin != tempWin.top && !canInspectWindow_(tempWin); j++, topXDomainWin = tempWin, tempWin = tempWin.parent) {}
...
function canInspectWindow_(win) {
  try {
    var unused = !!win.location.href && win['test']; // eslint-disable-line no-unused-vars
    return true;
  } catch (unusedErr) {
...
},{"../../src/3p-frame-messaging":9,"../../src/event-helper":18,"../../src/layout-rect":23,"../../src/log":24,"../../src/utils/object":46,"./frame-overlay-manager":2,"./position-observer":5}],5:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
  ...
  _createClass(PositionObserver, [{
    ...
    value: function getPositionEntry_(element) {
      return {
        ...
        targetRect: (0, _layoutRect.layoutRectFromDomRect)(element. /*OK*/getBoundingClientRect())
      };
    }
    ...
    value: function getViewportRect() {
      ...
      var scrollLeft = scrollingElement. /*OK*/scrollLeft || win. /*OK*/pageXOffset;
      var scrollTop = scrollingElement. /*OK*/scrollTop || win. /*OK*/pageYOffset;
      return (0, _layoutRect.layoutRectLtwh)(Math.round(scrollLeft), Math.round(scrollTop), win. /*OK*/innerWidth, win. /*OK*/innerHeight);
    }
  }]);
...
},{"../../src/layout-rect":23,"../../src/observable":27,"../../src/utils/rate-limit":48}],6:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./event-helper-listen":17,"./json":22,"./log":24,"./utils/object":46}],10:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
/**
...
},{"./services":37}],12:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
/**
...
},{"./config":12,"./string":38,"./url":44}],14:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"../third_party/css-escape/css-escape":49,"./log":24,"./string":38,"./types":41,"./utils/object":46,"./utils/promise":47}],15:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./dom":14,"./log":24,"./service":36,"./types":41}],16:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./amp-events":10,"./analytics":11,"./config":12,"./event-helper":18,"./experiments":19,"./exponential-backoff":20,"./log":24,"./mode":26,"./services":37,"./string":38,"./style-installer":39,"./url":44}],17:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./event-helper-listen":17,"./log":24}],19:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./cookies":13,"./url":44,"./utils/object":46}],20:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./style":40}],22:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./types":41}],23:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./mode":26,"./mode-object":25,"./types":41}],25:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
function getRtvVersion(win, isLocalDev) {
  ...
  // Currently `1533315368383` and thus `mode.version` contain only
  // major version. The full version however must also carry the minor version.
  // We will default to production default `01` minor version for now.
  // TODO(erwinmombay): decide whether 1533315368383 should contain
  // minor version.
  return '01' + version;
}
...
},{"./url-parse-query-string":42}],27:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./polyfills/array-includes":29,"./polyfills/document-contains":30,"./polyfills/domtokenlist-toggle":31,"./polyfills/math-sign":32,"./polyfills/object-assign":33,"./polyfills/promise":34,"document-register-element/build/document-register-element.patched":7}],29:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"promise-pjs/promise":8}],35:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./log":24,"./service":36,"./services":37}],36:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./log":24,"./polyfills":28,"./types":41,"./utils/promise":47}],37:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
var Services = exports.Services = function () {
  ...
  _createClass(Services, null, [{
    ...
    value: function geoForDocOrNull(elementOrAmpDoc) {
      return (/** @type {!Promise<?Object<string,(string|Array<string>)>>} */(0, _elementService.getElementServiceIfAvailableForDoc)(elementOrAmpDoc, 'geo', 'amp-geo', true)
      );
    }
...
},{"./dom":14,"./log":24,"./render-delaying-services":35,"./services":37,"./style":40,"./utils/object":46}],40:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./string":38,"./utils/object.js":46}],41:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./config":12,"./log":24,"./mode":26,"./string":38,"./types":41,"./url-parse-query-string":42,"./url-try-decode-uri-component":43,"./utils/lru-cache":45,"./utils/object":46}],45:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"../log":24}],46:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.map = map;
...
},{"../types":41}],47:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
