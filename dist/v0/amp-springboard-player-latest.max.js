(self.AMP=self.AMP||[]).push({n:"amp-springboard-player",v:"1533592753130",f:(function(AMP,_){
  ...
  */
  ...
  _createClass(AmpSpringboardPlayer, [{
    ...
    value: function layoutCallback() {
      ...
      var siteId = (0, _log.user)().assert(this.element.getAttribute('data-site-id'), 'The data-site-id attribute is required for' + '<amp-springboard-player> %s', this.element);
      var playerId = (0, _log.user)().assert(this.element.getAttribute('data-player-id'), 'The data-player-id attribute is required for' + '<amp-springboard-player> %s', this.element);
